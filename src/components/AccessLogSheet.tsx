        ...
        <div className="space-y-5 pb-6">
          ...
          <div className="flex justify-center gap-4">
            <div className="text-center">
              {residentPhoto ? (
                <img src={residentPhoto} alt="Morador" className="h-24 w-24 rounded-2xl object-cover border-2 border-primary/20 shadow-md" />
              ) : (
            ...
            {(carPhoto || log.plate) && (
              <div className="text-center">
                {carPhoto ? (
                  <img src={carPhoto} alt="Veículo" className="h-24 w-24 rounded-2xl object-cover border-2 border-accent/20 shadow-md" />
                ) : (
          ...
          {/* Name */}
          <div className="text-center">
            <p className="text-2xl font-extrabold text-foreground uppercase tracking-tight">{log.driver_name}</p>
          ...
          <div className="bg-secondary/60 rounded-2xl p-4 text-center">
            ...
            <p className="text-4xl font-extrabold text-foreground leading-tight tracking-tight">{log.destination}</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-secondary/40 rounded-xl p-3">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">Entrada</p>
              </div>
            ...
            <div className="bg-secondary/40 rounded-xl p-3">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">Saída</p>
              </div>
          ...
          {log.authorized_by && (
            <div className="bg-secondary/40 rounded-xl p-3 flex items-center gap-2">
              ...
              <p className="text-sm font-medium text-foreground">Liberado por: {log.authorized_by}</p>
            </div>
          )}
